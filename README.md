...
🎥 **Watch the interactive dashboard demo (with live slicer filtering):** [LinkedIn Post Link](https://www.linkedin.com/in/bijalwanankit)

*Note: The Power BI file (.pbit) is not included in this repository, to protect the dashboard design and DAX logic. Screenshots and a video walkthrough are provided instead — feel free to reach out on [LinkedIn](https://www.linkedin.com/in/bijalwanankit) if you'd like to discuss the implementation.*
...
**Ankit Bijalwan**
If you're working in BFSI / risk analytics and have feedback on this project, I'd love to hear it — feel free to reach out on [LinkedIn](https://www.linkedin.com/in/bijalwanankit).
